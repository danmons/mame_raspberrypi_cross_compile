...
sudo apt-get clean
sudo apt-get update
mkdir -p ~/aarch64_bullseye/debs
cd ~/aarch64_bullseye/debs
apt-get download -y \
apulse libasound2 libasound2-dev libasyncns0 libbrotli1 libbsd0 libcap2 \
libcom-err2 libdbus-1-3 libdouble-conversion3 libdrm2 libexpat1 libffi7 \
...
libharfbuzz0b libice6 libicu67 libk5crypto3 libkeyutils1 libkrb5-3 \
libkrb5support0 liblz4-1 liblzma5 libmd0 libogg0 libopus0 libpcre2-16-0 \
libpcre3 libpng16-16 libpulse0 libpulse-dev libqt5core5a libqt5gui5 \
libqt5widgets5 libraspberrypi0 libraspberrypi-bin libraspberrypi-dev \
libsdl1.2debian libsdl2-2.0-0 libsdl2-dev libsdl2-ttf-2.0-0 libsdl2-ttf-dev \
libsdl-image1.2 libsdl-mixer1.2 libsdl-ttf2.0-0 libsm6 libsndfile1 libsndio7.0 \
libsystemd0 libtirpc3 libuuid1 libvorbis0a libvorbisenc2 libwayland-client0 \
libwayland-cursor0 libwayland-egl1 libwayland-server0 libwrap0 libx11-6 \
libx11-data libx11-dev libx11-xcb1 libx264-160 libx265-192 libxau6 libxau-dev \
...
libxdmcp6 libxdmcp-dev libxext6 libxext-dev libxfconf-0-3 libxfixes3 \
...
x11proto-dev zlib1g libnsl2 libfontconfig-dev libfreetype-dev libmd4c0

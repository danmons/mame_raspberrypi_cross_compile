...
sudo apt-get install -y build-essential gcc g++ make automake autoconf coreutils wget curl aria2 p7zip p7zip-full git flex bison texi2html texinfo xz-utils bzip2 gzip zip unzip zstd help2man libtool libtool-bin awk
